...
from class_work.diplom.pages.locators import home_page_locators
from class_work.diplom.pages.base_page import BasePage
from class_work.diplom.pages.locators import profile_page_locators
